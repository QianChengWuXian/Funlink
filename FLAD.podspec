Pod::Spec.new do |s|
  ...
  s.subspec 'FLAdMedProADXAdapter' do |ss|
    ss.ios.deployment_target = '11.0'
    ss.dependency 'FLAD/FLAdSaas'
    ss.dependency 'YDMedProADXSDK'
    ss.vendored_frameworks = 'FLAD/FLAdMedProADXAdapter.xcframework'
  end

    s.subspec 'FLAdCxjAdapter' do |ss|
    ss.ios.deployment_target = '11.0'
    ss.dependency 'FLAD/FLAdSaas'
    ss.dependency 'YDCxjSDK'
    ss.vendored_frameworks = 'FLAD/FLAdCxjAdapter.xcframework'
  end

    s.subspec 'FLAdFunLinkAdapter' do |ss|
    ss.ios.deployment_target = '11.0'
    ss.dependency 'FLAD/FLAdSaas'
    ss.dependency 'FunlinkSDK'
    ss.vendored_frameworks = 'FLAD/FLAdFunLinkAdapter.xcframework'
  end

    s.subspec 'FLAdHcAdapter' do |ss|
    ss.ios.deployment_target = '11.0'
    ss.dependency 'FLAD/FLAdSaas'
    ss.dependency 'YDHcSDK'
    ss.vendored_frameworks = 'FLAD/FLAdHcAdapter.xcframework'
  end

    s.subspec 'FLAdMedProFTAdapter' do |ss|
    ss.ios.deployment_target = '11.0'
    ss.dependency 'FLAD/FLAdSaas'
    ss.dependency 'YDMedProFTSDK'
    ss.vendored_frameworks = 'FLAD/FLAdMedProFTAdapter.xcframework'
  end
